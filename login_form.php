<?php include 'header.php'; 
	...
	<div class="log-in">
		...
		<form  method="post" action="login.php">					
			...
			<p class="box"><a class="boxs" href="admin/login_form.php"><b>Log in as Admin</b></a></p>
			<br><br>
			<p class="box">If you don't have an account. Please <a class="boxs" href="registration_form.php"><b>Register an account</b></a></p>					
		</form>									
	</div>			
